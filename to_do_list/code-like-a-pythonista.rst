...
.. class:: small
   ...
   Â©2006-2008, licensed under a `Creative Commons
...
* Attributes: ``interface``, ``_internal``, ``__private``
  ...
  .. container:: handout
     ...
     ``_internal``. ã€€This isn't name mangled at all; it just
...
.. container:: handout
   ...
   This is the naÃ¯ve way to do it:
...
.. container:: handout
   ...
   dictionary value will be a list.  This is the naÃ¯ve way:
...
.. container:: handout
   ...
   For example, a list of the squares of 0â€“9:

   >>> [n ** 2 for n in range(10)]
   [0, 1, 4, 9, 16, 25, 36, 49, 64, 81]

   A list of the squares of odd 0â€“9:
